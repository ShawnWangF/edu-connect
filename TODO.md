...
## 新功能需求：必去景點 (2026-02-13) 🎯

### 團組必去行程功能
- [x] 更新數據庫schema，在groups表中添加requiredItineraries字段（JSON數組）
- [x] 在團組基u672cu4fe1u606fu9801面添加必去行程配置區域
- [x] 支持從景點資源選擇或手動輸入必去行程
- [x] 創建RequiredItinerariesDialog組件支持編輯必去行程
- [ ] 實現行程檢查邏輯，檢測未安排的必去行程
- [ ] 添加提醒機制，當有未安排的必去行程時顯示警告

## 新需求：行程詳情頁面顯示未安排的必去行程 (2026-02-13) 🎯

- [x] 實現行程檢查邏輯，對比必去行程和已安排行程
- [x] 在行程詳情標籤頁頂部添加未安排必去行程提示區域
- [x] 顯示未安排的必去行程列表（黃色警告框）
- [x] 測試功能並創建checkpoint

## 新發現的問題 (2026-02-13) 🐛

- [ ] 行程點創建時地點字段未保存（顯示「未指定地點」）
- [ ] 必去行程匹配邏輯無法識別未保存地點的行程點
- [ ] 需要修復行程點創建邏輯，確保location字段正確保存
