...
## 工作人員管理模塊重構（第五輪）
- [ ] 重新定位「人員管理」為「工作人員管理」概念
  - 工作人員角色：總統籌/協調員/工作人員/導遊/司機/安保
  - 指派工作人員至某個行程（某天負責哪個團組）
  - 狀態監控：工作人員當天的出勤狀態
- [ ] 更新數據庫 schema（使用現有 members 表或新建 staff 表）
- [ ] 更新後端 API（工作人員 CRUD、指派、狀態）
- [ ] 更新前端 UI（工作人員列表、指派行程、狀態監控）
- [ ] 驗證功能並保存檢查點
